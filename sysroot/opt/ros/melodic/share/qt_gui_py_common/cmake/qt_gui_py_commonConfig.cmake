...
if("FALSE" STREQUAL "TRUE")
  set(qt_gui_py_common_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-qt-gui-py-common-0.3.11)
  set(qt_gui_py_common_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-qt-gui-py-common-0.3.11/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qt_gui_py_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
