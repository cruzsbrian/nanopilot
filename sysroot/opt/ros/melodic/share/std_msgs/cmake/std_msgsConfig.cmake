...
if("FALSE" STREQUAL "TRUE")
  set(std_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-std-msgs-0.5.11)
  set(std_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-std-msgs-0.5.11/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'std_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
