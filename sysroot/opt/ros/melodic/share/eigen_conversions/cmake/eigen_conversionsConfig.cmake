...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-eigen-conversions-1.12.0)
  set(eigen_conversions_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-eigen-conversions-1.12.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
