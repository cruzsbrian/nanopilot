...
if("FALSE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-roslang-1.14.4)
  set(roslang_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-roslang-1.14.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
