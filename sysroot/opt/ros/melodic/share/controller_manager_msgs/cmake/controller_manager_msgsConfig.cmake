...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-controller-manager-msgs-0.15.1)
  set(controller_manager_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-controller-manager-msgs-0.15.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
