...
if("FALSE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-hardware-interface-0.15.1)
  set(hardware_interface_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-hardware-interface-0.15.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
