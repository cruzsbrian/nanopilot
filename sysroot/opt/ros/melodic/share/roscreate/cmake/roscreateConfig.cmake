...
if("FALSE" STREQUAL "TRUE")
  set(roscreate_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-roscreate-1.14.4)
  set(roscreate_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-roscreate-1.14.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
