...
if("FALSE" STREQUAL "TRUE")
  set(interactive_markers_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-interactive-markers-1.11.4)
  set(interactive_markers_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-interactive-markers-1.11.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
