...
if("FALSE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rospy-tutorials-0.9.0)
  set(rospy_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rospy-tutorials-0.9.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
