...
if("FALSE" STREQUAL "TRUE")
  ...
  set(kdl_parser_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-kdl-parser-1.13.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
