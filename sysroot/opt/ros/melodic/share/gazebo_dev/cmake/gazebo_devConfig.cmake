...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-gazebo-dev-2.8.4)
  set(gazebo_dev_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-gazebo-dev-2.8.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
