...
if("FALSE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-turtlesim-0.9.0)
  set(turtlesim_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-turtlesim-0.9.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
