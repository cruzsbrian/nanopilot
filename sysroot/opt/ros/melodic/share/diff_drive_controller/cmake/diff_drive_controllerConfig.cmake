...
if("FALSE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-diff-drive-controller-0.14.2)
  set(diff_drive_controller_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-diff-drive-controller-0.14.2/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
