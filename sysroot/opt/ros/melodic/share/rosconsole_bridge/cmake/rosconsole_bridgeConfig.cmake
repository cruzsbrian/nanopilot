...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_bridge_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rosconsole-bridge-0.5.2)
  set(rosconsole_bridge_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rosconsole-bridge-0.5.2/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
