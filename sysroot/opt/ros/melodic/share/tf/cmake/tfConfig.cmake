...
if("FALSE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-tf-1.12.0)
  set(tf_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-tf-1.12.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
