...
if("FALSE" STREQUAL "TRUE")
  set(visualization_marker_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-visualization-marker-tutorials-0.10.3)
  set(visualization_marker_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-visualization-marker-tutorials-0.10.3/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visualization_marker_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
