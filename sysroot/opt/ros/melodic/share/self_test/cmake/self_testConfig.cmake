...
if("FALSE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-self-test-1.9.3)
  set(self_test_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-self-test-1.9.3/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
