...
if("FALSE" STREQUAL "TRUE")
  set(urdfdom_py_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-urdfdom-py-0.4.0)
  set(urdfdom_py_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-urdfdom-py-0.4.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdfdom_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
