...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-depth-image-proc-1.12.23)
  set(depth_image_proc_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-depth-image-proc-1.12.23/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
