...
if("FALSE" STREQUAL "TRUE")
  set(topic_tools_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-topic-tools-1.14.3)
  set(topic_tools_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-topic-tools-1.14.3/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
