...
if("FALSE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-joint-limits-interface-0.15.1)
  set(joint_limits_interface_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-joint-limits-interface-0.15.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
