...
if("FALSE" STREQUAL "TRUE")
  ...
  set(pluginlib_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-pluginlib-1.12.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
