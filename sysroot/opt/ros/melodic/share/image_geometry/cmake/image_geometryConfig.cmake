...
if("FALSE" STREQUAL "TRUE")
  ...
  set(image_geometry_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-image-geometry-1.13.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
