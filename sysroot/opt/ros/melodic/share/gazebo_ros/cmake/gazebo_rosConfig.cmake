...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-gazebo-ros-2.8.4)
  set(gazebo_ros_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-gazebo-ros-2.8.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gazebo_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_api_plugin;gazebo_ros_paths_plugin;/usr/lib/arm-linux-gnueabihf/libtinyxml.so")
