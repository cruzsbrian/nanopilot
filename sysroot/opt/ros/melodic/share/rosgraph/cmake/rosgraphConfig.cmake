...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rosgraph-1.14.3)
  set(rosgraph_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rosgraph-1.14.3/obj-arm-linux-gnueabihf/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
