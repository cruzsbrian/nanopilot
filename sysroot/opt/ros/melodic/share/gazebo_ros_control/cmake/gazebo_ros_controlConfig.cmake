...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_control_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-gazebo-ros-control-2.8.4)
  set(gazebo_ros_control_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-gazebo-ros-control-2.8.4/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
