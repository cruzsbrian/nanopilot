...
if("FALSE" STREQUAL "TRUE")
  set(laser_filters_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-laser-filters-1.8.6)
  set(laser_filters_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-laser-filters-1.8.6/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
