...
if("FALSE" STREQUAL "TRUE")
  ...
  set(compressed_image_transport_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-compressed-image-transport-1.9.5/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
