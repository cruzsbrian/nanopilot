...
if("FALSE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-libmavconn-0.29.2)
  set(libmavconn_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-libmavconn-0.29.2/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/opt/ros/melodic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
