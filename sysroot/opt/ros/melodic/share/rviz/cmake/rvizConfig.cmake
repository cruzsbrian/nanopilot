...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rviz-1.13.1)
  set(rviz_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rviz-1.13.1/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
