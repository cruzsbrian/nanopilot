...
if("FALSE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rosbag-1.14.3)
  set(rosbag_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rosbag-1.14.3/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
