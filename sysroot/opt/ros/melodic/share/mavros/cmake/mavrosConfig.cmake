...
if("FALSE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-mavros-0.29.2)
  set(mavros_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-mavros-0.29.2/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
