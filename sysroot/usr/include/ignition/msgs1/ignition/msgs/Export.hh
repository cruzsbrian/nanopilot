...
/// For ignition-msgs developers: Apply this macro to
/// ignition-msgs functions and classes which consumers of
...
/// For ignition-msgs developers: Apply this macro to
/// ignition-msgs functions and classes which must not be
/// used by consumers of this library. By default, this property is applied to
/// all classes and functions which are not tagged with IGNITION_MSGS_VISIBLE,
...
/// For ignition-msgs developers: Use this macro to indicate
