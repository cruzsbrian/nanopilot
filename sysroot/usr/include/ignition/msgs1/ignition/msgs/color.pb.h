...
class IGNITION_MSGS_VISIBLE Color : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Color) */ {
 ...
 private:
  ...
  float b_;
  float a_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fcolor_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fcolor_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fcolor_2eproto();
...
inline void Color::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Color::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Color::clear_header() {
...
#endif  // PROTOBUF_ignition_2fmsgs_2fcolor_2eproto__INCLUDED
