...
#ifndef PROTOBUF_ignition_2fmsgs_2fprojector_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fprojector_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Projector : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Projector) */ {
 ...
 private:
  ...
  double far_clip_;
  bool enabled_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fprojector_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fprojector_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fprojector_2eproto();
...
inline void Projector::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Projector::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Projector::clear_header() {
...
#endif  // PROTOBUF_ignition_2fmsgs_2fprojector_2eproto__INCLUDED
