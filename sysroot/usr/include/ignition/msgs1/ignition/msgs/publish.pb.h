...
#ifndef PROTOBUF_ignition_2fmsgs_2fpublish_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fpublish_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Publish : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Publish) */ {
 ...
 private:
  ...
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fpublish_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fpublish_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fpublish_2eproto();
...
inline void Publish::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Publish::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Publish::clear_header() {
...
#endif  // PROTOBUF_ignition_2fmsgs_2fpublish_2eproto__INCLUDED
