...
#ifndef PROTOBUF_ignition_2fmsgs_2fsky_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fsky_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Sky : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Sky) */ {
 ...
 private:
  ...
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fsky_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fsky_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fsky_2eproto();
...
inline void Sky::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Sky::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Sky::clear_header() {
...
inline void Sky::clear_cloud_ambient() {
  if (cloud_ambient_ != NULL) cloud_ambient_->::ignition::msgs::Color::Clear();
...
inline ::ignition::msgs::Color* Sky::mutable_cloud_ambient() {
  ...
  if (cloud_ambient_ == NULL) {
    cloud_ambient_ = new ::ignition::msgs::Color;
  }
...
#endif  // PROTOBUF_ignition_2fmsgs_2fsky_2eproto__INCLUDED
