...
#ifndef PROTOBUF_ignition_2fmsgs_2fwrench_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fwrench_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Wrench : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Wrench) */ {
 ...
 private:
  ...
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fwrench_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fwrench_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fwrench_2eproto();
...
inline void Wrench::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Wrench::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Wrench::clear_header() {
...
inline void Wrench::clear_force() {
  if (force_ != NULL) force_->::ignition::msgs::Vector3d::Clear();
  clear_has_force();
}
...
inline ::ignition::msgs::Vector3d* Wrench::mutable_force() {
  set_has_force();
  if (force_ == NULL) {
    force_ = new ::ignition::msgs::Vector3d;
  }
...
inline void Wrench::clear_torque() {
  if (torque_ != NULL) torque_->::ignition::msgs::Vector3d::Clear();
  clear_has_torque();
}
...
inline ::ignition::msgs::Vector3d* Wrench::mutable_torque() {
  set_has_torque();
  if (torque_ == NULL) {
    torque_ = new ::ignition::msgs::Vector3d;
  }
...
inline void Wrench::clear_force_offset() {
  if (force_offset_ != NULL) force_offset_->::ignition::msgs::Vector3d::Clear();
...
inline ::ignition::msgs::Vector3d* Wrench::mutable_force_offset() {
  ...
  if (force_offset_ == NULL) {
    force_offset_ = new ::ignition::msgs::Vector3d;
  }
...
#endif  // PROTOBUF_ignition_2fmsgs_2fwrench_2eproto__INCLUDED
