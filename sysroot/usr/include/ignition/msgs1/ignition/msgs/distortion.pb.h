...
#ifndef PROTOBUF_ignition_2fmsgs_2fdistortion_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fdistortion_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Distortion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Distortion) */ {
 ...
 private:
  ...
  double p1_;
  double p2_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fdistortion_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fdistortion_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fdistortion_2eproto();
...
inline void Distortion::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Distortion::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Distortion::clear_header() {
...
inline void Distortion::clear_center() {
  if (center_ != NULL) center_->::ignition::msgs::Vector2d::Clear();
  clear_has_center();
}
...
inline ::ignition::msgs::Vector2d* Distortion::mutable_center() {
  set_has_center();
  if (center_ == NULL) {
    center_ = new ::ignition::msgs::Vector2d;
  }
...
#endif  // PROTOBUF_ignition_2fmsgs_2fdistortion_2eproto__INCLUDED
