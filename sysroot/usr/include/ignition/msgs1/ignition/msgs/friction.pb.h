...
#ifndef PROTOBUF_ignition_2fmsgs_2ffriction_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2ffriction_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Friction_Torsional_ODE : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Friction.Torsional.ODE) */ {
 ...
 private:
  ...
  double slip_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2ffriction_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2ffriction_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2ffriction_2eproto();
...
inline void Friction_Torsional::clear_ode() {
  if (ode_ != NULL) ode_->::ignition::msgs::Friction_Torsional_ODE::Clear();
  clear_has_ode();
}
...
inline ::ignition::msgs::Friction_Torsional_ODE* Friction_Torsional::mutable_ode() {
  set_has_ode();
  if (ode_ == NULL) {
    ode_ = new ::ignition::msgs::Friction_Torsional_ODE;
  }
...
inline void Friction::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Friction::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Friction::clear_header() {
...
inline void Friction::clear_fdir1() {
  if (fdir1_ != NULL) fdir1_->::ignition::msgs::Vector3d::Clear();
  clear_has_fdir1();
}
...
inline ::ignition::msgs::Vector3d* Friction::mutable_fdir1() {
  set_has_fdir1();
  if (fdir1_ == NULL) {
    fdir1_ = new ::ignition::msgs::Vector3d;
  }
...
inline void Friction::clear_torsional() {
  if (torsional_ != NULL) torsional_->::ignition::msgs::Friction_Torsional::Clear();
  clear_has_torsional();
}
...
inline ::ignition::msgs::Friction_Torsional* Friction::mutable_torsional() {
  set_has_torsional();
  if (torsional_ == NULL) {
    torsional_ = new ::ignition::msgs::Friction_Torsional;
  }
...
#endif  // PROTOBUF_ignition_2fmsgs_2ffriction_2eproto__INCLUDED
