...
#ifndef PROTOBUF_ignition_2fmsgs_2fany_2eproto__INCLUDED
#define PROTOBUF_ignition_2fmsgs_2fany_2eproto__INCLUDED
...
class IGNITION_MSGS_VISIBLE Any : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ignition.msgs.Any) */ {
 ...
 private:
  ...
  bool bool_value_;
  friend void IGNITION_MSGS_VISIBLE protobuf_AddDesc_ignition_2fmsgs_2fany_2eproto();
  friend void protobuf_AssignDesc_ignition_2fmsgs_2fany_2eproto();
  friend void protobuf_ShutdownFile_ignition_2fmsgs_2fany_2eproto();
...
inline void Any::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Any::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Any::clear_header() {
...
inline void Any::clear_vector3d_value() {
  if (vector3d_value_ != NULL) vector3d_value_->::ignition::msgs::Vector3d::Clear();
...
inline ::ignition::msgs::Vector3d* Any::mutable_vector3d_value() {
  ...
  if (vector3d_value_ == NULL) {
    vector3d_value_ = new ::ignition::msgs::Vector3d;
  }
...
inline void Any::clear_color_value() {
  if (color_value_ != NULL) color_value_->::ignition::msgs::Color::Clear();
...
inline ::ignition::msgs::Color* Any::mutable_color_value() {
  ...
  if (color_value_ == NULL) {
    color_value_ = new ::ignition::msgs::Color;
  }
...
inline void Any::clear_pose3d_value() {
  if (pose3d_value_ != NULL) pose3d_value_->::ignition::msgs::Pose::Clear();
...
inline ::ignition::msgs::Pose* Any::mutable_pose3d_value() {
  ...
  if (pose3d_value_ == NULL) {
    pose3d_value_ = new ::ignition::msgs::Pose;
  }
...
inline void Any::clear_quaternion_value() {
  if (quaternion_value_ != NULL) quaternion_value_->::ignition::msgs::Quaternion::Clear();
...
inline ::ignition::msgs::Quaternion* Any::mutable_quaternion_value() {
  ...
  if (quaternion_value_ == NULL) {
    quaternion_value_ = new ::ignition::msgs::Quaternion;
  }
...
inline void Any::clear_time_value() {
  if (time_value_ != NULL) time_value_->::ignition::msgs::Time::Clear();
...
inline ::ignition::msgs::Time* Any::mutable_time_value() {
  set_has_time_value();
  if (time_value_ == NULL) {
    time_value_ = new ::ignition::msgs::Time;
  }
...
template <> struct is_proto_enum< ::ignition::msgs::Any_ValueType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_ignition_2fmsgs_2fany_2eproto__INCLUDED
