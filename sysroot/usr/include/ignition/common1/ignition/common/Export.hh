...
/// For ignition-common developers: Apply this macro to
/// ignition-common functions and classes which consumers of
...
/// For ignition-common developers: Apply this macro to
/// ignition-common functions and classes which must not be
/// used by consumers of this library. By default, this property is applied to
/// all classes and functions which are not tagged with IGNITION_COMMON_VISIBLE,
...
/// For ignition-common developers: Use this macro to indicate
