...
/// For ignition-transport developers: Apply this macro to
/// ignition-transport functions and classes which consumers of
...
/// For ignition-transport developers: Apply this macro to
/// ignition-transport functions and classes which must not be
/// used by consumers of this library. By default, this property is applied to
/// all classes and functions which are not tagged with IGNITION_TRANSPORT_VISIBLE,
...
/// For ignition-transport developers: Use this macro to indicate
