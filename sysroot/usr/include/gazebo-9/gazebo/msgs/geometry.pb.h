...
inline ::gazebo::msgs::CylinderGeom* Geometry::mutable_cylinder() {
  set_has_cylinder();
  if (cylinder_ == NULL) {
    cylinder_ = new ::gazebo::msgs::CylinderGeom;
  }
...
inline ::gazebo::msgs::PlaneGeom* Geometry::mutable_plane() {
  set_has_plane();
  if (plane_ == NULL) {
    plane_ = new ::gazebo::msgs::PlaneGeom;
  }
...
inline ::gazebo::msgs::SphereGeom* Geometry::mutable_sphere() {
  set_has_sphere();
  if (sphere_ == NULL) {
    sphere_ = new ::gazebo::msgs::SphereGeom;
  }
...
inline ::gazebo::msgs::ImageGeom* Geometry::mutable_image() {
  set_has_image();
  if (image_ == NULL) {
    image_ = new ::gazebo::msgs::ImageGeom;
  }
...
inline ::gazebo::msgs::HeightmapGeom* Geometry::mutable_heightmap() {
  set_has_heightmap();
  if (heightmap_ == NULL) {
    heightmap_ = new ::gazebo::msgs::HeightmapGeom;
  }
...
inline ::gazebo::msgs::MeshGeom* Geometry::mutable_mesh() {
  set_has_mesh();
  if (mesh_ == NULL) {
    mesh_ = new ::gazebo::msgs::MeshGeom;
  }
