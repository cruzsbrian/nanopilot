...
inline void Link::clear_density() {
  if (density_ != NULL) density_->::gazebo::msgs::Density::Clear();
  clear_has_density();
}
...
inline ::gazebo::msgs::Density* Link::mutable_density() {
  set_has_density();
  if (density_ == NULL) {
    density_ = new ::gazebo::msgs::Density;
  }
...
inline ::gazebo::msgs::Inertial* Link::mutable_inertial() {
  set_has_inertial();
  if (inertial_ == NULL) {
    inertial_ = new ::gazebo::msgs::Inertial;
  }
...
inline void Link::clear_wind() {
  if (wind_ != NULL) wind_->::gazebo::msgs::Vector3d::Clear();
  clear_has_wind();
}
...
inline ::gazebo::msgs::Vector3d* Link::mutable_wind() {
  set_has_wind();
  if (wind_ == NULL) {
    wind_ = new ::gazebo::msgs::Vector3d;
  }
