...
inline ::gazebo::msgs::Vector3d* Any::mutable_vector3d_value() {
  ...
  if (vector3d_value_ == NULL) {
    vector3d_value_ = new ::gazebo::msgs::Vector3d;
  }
...
inline ::gazebo::msgs::Color* Any::mutable_color_value() {
  ...
  if (color_value_ == NULL) {
    color_value_ = new ::gazebo::msgs::Color;
  }
...
inline ::gazebo::msgs::Pose* Any::mutable_pose3d_value() {
  ...
  if (pose3d_value_ == NULL) {
    pose3d_value_ = new ::gazebo::msgs::Pose;
  }
...
inline ::gazebo::msgs::Quaternion* Any::mutable_quaternion_value() {
  ...
  if (quaternion_value_ == NULL) {
    quaternion_value_ = new ::gazebo::msgs::Quaternion;
  }
...
inline ::gazebo::msgs::Time* Any::mutable_time_value() {
  set_has_time_value();
  if (time_value_ == NULL) {
    time_value_ = new ::gazebo::msgs::Time;
  }
