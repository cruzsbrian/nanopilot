...
#define ARMA_AUX_LIBS /usr/lib/arm-linux-gnueabihf/libblas.so;/usr/lib/arm-linux-gnueabihf/liblapack.so;/usr/lib/arm-linux-gnueabihf/libarpack.so;/usr/lib/arm-linux-gnueabihf/libsuperlu.so
