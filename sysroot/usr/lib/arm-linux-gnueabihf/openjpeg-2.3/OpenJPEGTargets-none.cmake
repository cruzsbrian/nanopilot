...
set_target_properties(openjp2 PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjp2.so.2.3.0"
  IMPORTED_SONAME_NONE "libopenjp2.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjp2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjp2 "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjp2.so.2.3.0" )
...
set_target_properties(openjp2_static PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjp2.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjp2_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjp2_static "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjp2.a" )
...
set_target_properties(openjpip PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjpip.so.2.3.0"
  IMPORTED_SONAME_NONE "libopenjpip.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjpip )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjpip "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjpip.so.2.3.0" )
...
set_target_properties(openjpip_server PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NONE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_NONE "/usr/lib/arm-linux-gnueabihf/libfcgi.so;/usr/lib/arm-linux-gnueabihf/libcurl.so;-lpthread"
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjpip_server.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjpip_server )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjpip_server "${_IMPORT_PREFIX}/lib/arm-linux-gnueabihf/libopenjpip_server.a" )
