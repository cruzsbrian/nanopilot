...
set(GAZEBO_PLUGIN_PATH "/usr/lib/arm-linux-gnueabihf/gazebo-9/plugins")
...
find_library(gazebo_proto_msgs_lib gazebo_msgs
  PATHS "/usr/lib/arm-linux-gnueabihf" NO_DEFAULT_PATH)
...
list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/arm-linux-gnueabihf)
list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/arm-linux-gnueabihf/gazebo-9/plugins)
...
list(APPEND GAZEBO_LDFLAGS -Wl,-rpath,/usr/lib/arm-linux-gnueabihf/gazebo-9/plugins)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/arm-linux-gnueabihf)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/arm-linux-gnueabihf/gazebo-9/plugins)
