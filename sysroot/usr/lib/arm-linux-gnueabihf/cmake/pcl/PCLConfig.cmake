...
if(EXISTS "${PCL_ROOT}/include/pcl-${PCL_VERSION_MAJOR}.${PCL_VERSION_MINOR}/pcl/pcl_config.h")
  ...
  set(PCL_LIBRARY_DIRS "${PCL_ROOT}/lib/arm-linux-gnueabihf")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_LIBRARY_DIRS "${PCL_DIR}/lib/arm-linux-gnueabihf")
  set(PCL_SOURCES_TREE "/build/pcl-lfYe4y/pcl-1.8.1+dfsg1")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d geometry features ml segmentation visualization surface registration keypoints tracking recognition stereo apps outofcore people )
