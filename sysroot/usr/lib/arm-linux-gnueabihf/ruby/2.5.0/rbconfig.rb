...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--enable-multiarch' '--target=arm-linux-gnueabihf' '--program-suffix=2.5' '--with-soname=ruby-2.5' '--enable-shared' '--disable-rpath' '--with-sitedir=/usr/local/lib/site_ruby' '--with-sitearchdir=/usr/local/lib/arm-linux-gnueabihf/site_ruby' '--runstatedir=/var/run' '--localstatedir=/var' '--sysconfdir=/etc' '--enable-ipv6' '--with-dbm-type=gdbm_compat' 'CFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security' 'FCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong' 'FFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong' 'GCJFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong' 'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' 'OBJCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security' 'OBJCXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security' 'target_alias=arm-linux-gnueabihf'"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.5-Il_Wkn/ruby2.5-2.5.1=. -fstack-protector-strong -Wformat -Werror=format-security -fPIC"
  CONFIG["CC"] = "gcc"
