...
cf_time='Wed Jul 18 14:21:03 UTC 2018'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg6='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-VDhoP_/perl-5.26.1=. -fstack-protector-strong -Wformat -Werror=format-security'
