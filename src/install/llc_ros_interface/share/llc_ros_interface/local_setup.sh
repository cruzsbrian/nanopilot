...
: ${AMENT_CURRENT_PREFIX:="/home/brian/dev/leo/src/install/llc_ros_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/llc_ros_interface/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/llc_ros_interface/environment/path.sh"
