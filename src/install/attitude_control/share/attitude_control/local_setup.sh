...
: ${AMENT_CURRENT_PREFIX:="/home/brian/dev/leo/src/install/attitude_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/attitude_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/attitude_control/environment/path.sh"
