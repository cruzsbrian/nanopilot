...
: ${AMENT_CURRENT_PREFIX:="/home/brian/dev/leo/src/install/rc_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rc_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rc_control/environment/path.sh"
