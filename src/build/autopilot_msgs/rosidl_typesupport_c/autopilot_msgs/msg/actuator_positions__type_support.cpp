...
static const _ActuatorPositions_type_support_symbol_names_t _ActuatorPositions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopilot_msgs, msg, ActuatorPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopilot_msgs, msg, ActuatorPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopilot_msgs, msg, ActuatorPositions)() {
  return &::autopilot_msgs::msg::rosidl_typesupport_c::ActuatorPositions_message_type_support_handle;
}
