...
static const _RateControlSetpoint_type_support_symbol_names_t _RateControlSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopilot_msgs, msg, RateControlSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autopilot_msgs, msg, RateControlSetpoint)),
  }
};
...
{
  return &::autopilot_msgs::msg::rosidl_typesupport_cpp::RateControlSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autopilot_msgs, msg, RateControlSetpoint)() {
  return get_message_type_support_handle<autopilot_msgs::msg::RateControlSetpoint>();
}
